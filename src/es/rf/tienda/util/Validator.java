...
public class Validator {
	...
	private static final String ALFANUMERIC_PATTERN = "^[0-9a-zA-Z \\.,;\\-áéíóúàèìò]+$";
	...
	public static boolean isVacio(String prueba){
		if(prueba==null || prueba.length()==0) return true;
		else return false;
	}
	...
	// Se puede preguntar si un integer es nulo? 
	...
	public static boolean cumpleLongitudMin(String texto,int longitudMinima) {
		if ( !isVacio(texto) && texto.length()>=longitudMinima) return true;
		else return false;
	}
	...
	public static boolean cumpleLongitudMax(String texto, int longitudMaxima) {
		if ( !isVacio(texto) && texto.length()<=longitudMaxima) return true;
		else return false;
	}
	...
	public static boolean cumpleLongitud(String texto, int longitudMinima, int longitudMaxima){
			return (cumpleLongitudMax(texto,longitudMaxima) && cumpleLongitudMin(texto,longitudMinima));
	}
	/**
